...
$$
\eta=\sqrt{\frac{\mu}{\varepsilon}}(背诵)
$$

$$
w_e=w_m,
\qquad
w_{av}=\frac{1}{2}\varepsilon E_m^2=\frac{1}{2}\mu H_m^2(背诵)
$$

$$
\vec{S}_{av}=\frac{1}{2}\operatorname{Re}(\vec{E}\times\vec{H}^{*})=\vec{e}_z\frac{E_m^2}{2\eta}(背诵)
$$
