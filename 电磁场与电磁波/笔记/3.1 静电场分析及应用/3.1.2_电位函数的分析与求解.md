...
### 电位与电位函数是什么？
1. **电位函数的定义**
   ==电位函数==（用 $\phi$ 或 $\varphi$ 表示）就是满足无旋数学定理的空间标量函数。定义空间中各点的电场强度等于该标量函数的负梯度：
   $$ \vec{E} = -\nabla \phi $$
...
由上述推导可得，**体电荷的电位**为：
$$ \varphi(\vec{r}) = \frac{1}{4 \pi \varepsilon} \int_V \frac{\rho(\vec{r}')}{R} \mathrm{d}V' + C $$
...
P、Q 两点间的**电位差**等于电场力将单位正电荷从P点移至Q点所做的功。电场力使单位正电荷由高电位处移到低电位处。电位差也称为电压，用 $U$ 表示。
...
$$
![](../../教材和PPT/images/97a099be1a1254fcfc6ffd8d0e53c43dd4895305981e71b43e90530bb6b54e2a.jpg)
...
$$
![](../../教材和PPT/images/237e9f390c7d47726b778fb6b42e09dab9ceedce2382938a3878eb43f1d2a09c.jpg)
...
设 $P_1$ 和 $P_2$ 是介质分界面两侧紧贴界面的相邻两点，电位分别为 $\varphi_1$ 和 $\varphi_2$。当两点间距离趋于零 $\Delta l \to 0$ 时，电位的变化满足：
...
对于导体表面上电位的边界条件：导体表面是等位面，具有 $\phi =$ 常数。# 3.1.2 电位函数的分析与求解 (预习笔记)
