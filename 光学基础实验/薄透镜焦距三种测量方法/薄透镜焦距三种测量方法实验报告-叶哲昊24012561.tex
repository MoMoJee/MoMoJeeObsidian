...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.58\textwidth]{光路图/一-自准直法.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.78\textwidth]{光路图/二-二次成像法.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.70\textwidth]{光路图/三-平行光管法.png}
  \caption{平行光管法测凸透镜焦距原理图}
  \label{fig:collimator-principle}
\end{figure}
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.58\textwidth]{光路图/一-自准直法.png}
  \caption{自准直法光路图}
  \label{fig:thinking-zizhi}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.78\textwidth]{光路图/二-二次成像法.png}
  \caption{二次成像法（贝塞尔法）光路图}
  \label{fig:thinking-bessel}
\end{figure}
