...
\begin{enumerate}
  \item 在导轨上依次放置目镜（$f_e'=30\,\text{mm}$）、物镜（$f_o'=150\,\text{mm}$）和毫米标尺。目标标尺与物镜间的距离要求大于2倍物镜焦距（即 $L_1>300\,\text{mm}$）。实验装置实拍如图~\ref{fig:telescope_photo}所示。

  \begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{实验照片/实验一光路图.jpg}
    \caption{望远镜实验装置实拍}
...
\begin{enumerate}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.80\textwidth]{实验照片/实验二显微镜光路图.jpg}
    \caption{显微镜实验装置实拍}
    \label{fig:microscope_photo}
  \end{figure}
...
实验中通过目镜实际观察到的视场如图~\ref{fig:eyepiece_photo}所示，图中可见红色分辨率板4号条纹像与毫米标尺刻度同时出现在视野中，验证了分束镜叠加测量方案的有效性。

\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\textwidth]{实验照片/实验二显微镜目镜画面实拍.jpg}
  \caption{显微镜目镜视场实拍（分辨率板条纹像与毫米标尺叠加）}
  \label{fig:eyepiece_photo}
\end{figure}
